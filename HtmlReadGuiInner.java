...
public class HtmlReadGuiInner extends JPanel {
	...
	public HtmlReadGuiInner() { // Constructor to build the GUI
		setUp();
	}
	...
	private void setUp() {
		...
		this.buttonDownload = new JButton("DOWNLOAD"); // Creates the download button and adds
		add(buttonDownload);
		buttonDownload.addActionListener(new ActionListener() { // Makes the download button functional
	...
	public static void main(String[] args) { // Main method to create the GUI on a frame
		
	
		HtmlReadGuiInner htmlgui = new HtmlReadGuiInner();
